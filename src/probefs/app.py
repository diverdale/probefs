...
class ProbeFSApp(App):
    ...
    BINDINGS = [
        ...
        Binding("enter", "screen.enter_dir", "",
        ...
        Binding("backspace", "screen.leave_dir", "",
                priority=True, show=False, id="probefs.leave_dir_backspace"),
        Binding("question_mark", "screen.help", "Help",
                priority=True, show=True, id="probefs.help"),
        ...
        Binding("s", "screen.sort", "Sort",
                priority=True, show=False, id="probefs.sort"),
        Binding("/", "screen.filter", "Filter",
                priority=True, show=False, id="probefs.filter"),
        Binding("ctrl+o", "screen.go_back", "Back",
                priority=True, show=False, id="probefs.go_back"),
        Binding("ctrl+i", "screen.go_forward", "Forward",
                priority=True, show=False, id="probefs.go_forward"),
        Binding("g", "screen.goto", "Go to path",
                priority=True, show=False, id="probefs.goto"),
        Binding("Y", "screen.copy_path", "Copy path",
        ...
        Binding("a", "screen.about", "About",
                priority=True, show=False, id="probefs.about"),
